...
//==================================CONSTRUTOR==============================================================
  ...
  //Criando construtores nomeados
  //posso ao invez de ola colocar qualquer nome que eu quiser !
  DataSimples.ola({this.dia = 1, this.mes = 1, this.ano = 1970});

  //posso criar um construtor nomeado que tenha um corpo e um parametro obrigatorio
  DataSimples.corpo(this.ano) {
    dia = 31;
    mes = 12;
  }
...
main() {
  ...
  //apresentando o contrutor nomeado
  print(DataSimples.ola(ano: 2025));

  var dataFinal = DataSimples.ola(dia: 12, mes: 07, ano: 2024);
  print("Apresentando a data do construtor nomeado que criei $dataFinal");

  //apresentando o construtor nomeado com corpo
  print(DataSimples.corpo(2029));
}
